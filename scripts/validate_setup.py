...
def check_emulator_connectivity():
    ...
    try:
        ...
        print(
            "    Start with: docker run -p 10000:10000 mcr.microsoft.com/azure-storage/azurite"
        )
        azurite_ok = False
    ...
    try:
        ...
        if "eventhubs-emulator" in result.stdout:
            ...
            print(
                "    Start with: docker run -p 5672:5672 mcr.microsoft.com/azure-messaging/eventhubs-emulator"
            )
            eventhub_ok = False
