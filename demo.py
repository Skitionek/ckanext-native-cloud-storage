...
def demo_basic_functionality():
    ...
    try:
        from ckanext.native_cloud_storage import plugin
        from ckanext.native_cloud_storage import storage
    ...
    try:
        ...
        with patch('ckanext.native_cloud_storage.storage.config') as mock_config, \
            ...
            mock_config.get.side_effect = lambda key, default='': test_config.get(key, default)
    ...
    try:
        with patch('ckanext.native_cloud_storage.plugin.toolkit'), \
