...
class TestAzureBlobStorage:
    ...
    def test_emulator_mode_detection(self, mock_config):
        ...
        mock_config.get.side_effect = lambda key, default=None: self.test_config.get(
            key, default
        )
    ...
    def test_data_lake_service_client_creation_emulator(
        self, mock_service_client, mock_config
    ):
